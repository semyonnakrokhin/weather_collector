...
class WeatherUnitOfWork(BaseUnitOfWork):
    ...
    async def __aenter__(self):
        ...
        Calls the base class entry method and retrieves the
        WeatherDatabaseRepository instance.
        """
        await super().__aenter__()
        self.weather_database_repository = self.get_repository(
            repository_class=WeatherDatabaseRepository
        )
